defmodule PhxRpsWeb.Presence do
  @moduledoc """
  ...
  Presences can be tracked in your channel after joining:
      ...
      defmodule PhxRpsWeb.MyChannel do
        use PhxRpsWebWeb, :channel
  ...
  """
  use Phoenix.Presence, otp_app: :phx_rps,
                        pubsub_server: PhxRpsWeb.PubSub
end
